...
The following code creates a generative art piece of 3 seperate spirographs.
There are two seperate turtles that create 2 hexagonal spirographs and 1 octogonal spirograph.
Additionally, the spirographs are randomized to show a different color each time that the
code is run. This code is meant to evoke a joyful and playful reaction with its color
palette and somewhat simplistic design.
...
pinkPalette = ("pink","HotPink","DeepPink")
